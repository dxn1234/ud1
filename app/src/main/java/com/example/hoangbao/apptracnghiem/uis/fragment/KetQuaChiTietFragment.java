...
public class KetQuaChiTietFragment extends Fragment{
    TextView txtketquachitietstt,txtketquachitietcauhoi;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        anhXa();
//        txtketquachitietcauhoi.setText("Câu hỏi "+1);
//        txtketquachitietcauhoi.setText(LamBaiThiFragment.questionArrayList.get(0).getCauhoi());
//        rbketquachitieta.setText(LamBaiThiFragment.questionArrayList.get(0).getRadioButtona().getText());
//        rbketquachitietb.setText(LamBaiThiFragment.questionArrayList.get(0).getRadioButtonb().getText());
//        rbketquachitietc.setText(LamBaiThiFragment.questionArrayList.get(0).getRadioButtonc().getText());
//        rbketquachitietd.setText(LamBaiThiFragment.questionArrayList.get(0).getRadioButtond().getText());
...
//        }
//        else if(LamBaiThiFragment.stringArrayListdapan.get(0).equals("B")){
//            rbketquachitietb.setTextColor(getResources().getColor(R.color.mauxanh));
//        }
//        else if(LamBaiThiFragment.stringArrayListdapan.get(0).equals("C")){
//            rbketquachitietc.setTextColor(getResources().getColor(R.color.mauxanh));
//        }
//        else if(LamBaiThiFragment.stringArrayListdapan.get(0).equals("D")){
...
//                }
    ...
    private void cauHoiKeTiep() {
        int dem=stt+1;
        txtketquachitietstt.setText("Câu hỏi "+dem);
        txtketquachitietcauhoi.setText(LamBaiThiFragment.questionArrayList.get(stt).getCauhoi());
        rbketquachitieta.setText(LamBaiThiFragment.questionArrayList.get(stt).getRadioButtona().getText());
        rbketquachitietb.setText(LamBaiThiFragment.questionArrayList.get(stt).getRadioButtonb().getText());
        rbketquachitietc.setText(LamBaiThiFragment.questionArrayList.get(stt).getRadioButtonc().getText());
        rbketquachitietd.setText(LamBaiThiFragment.questionArrayList.get(stt).getRadioButtond().getText());
        if(LamBaiThiFragment.stringArrayListdapan.get(0).equals("A")){
            rbketquachitieta.setTextColor(getResources().getColor(R.color.mauxanh));
        }
        else if(LamBaiThiFragment.stringArrayListdapan.get(0).equals("B")){
    ...
    private void anhXa() {
        txtketquachitietstt=view.findViewById(R.id.txt_ketquachitietstt);
